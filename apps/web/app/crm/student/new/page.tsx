...
function SelectField({
  ...
  return (
    <Field label={label}>
      <select name={name} required={required} className={selectClassName}>
...
export default async function NewStudentPage() {
  ...
  return (
    <>
      ...
      <form action={createStudent} className="grid gap-6">
        <Card>
          <CardHeader>
          ...
          <CardContent className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            <Field label="Enrollment Number">
              <Input name="enrollmentNumber" required />
            </Field>
        ...
        <Card>
          ...
          <CardContent className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            ...
            <div className="md:col-span-2 xl:col-span-3">
              <Field label="Address">
                <textarea name="address" className={textareaClassName} />
              </Field>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            <SelectField
              ...
              required
            />
            <SelectField name="source" label="Source" data={SOURCES} required />
            <SelectField
              name="status"
              label="Status"
              data={LEAD_STATUS}
              required
            />
            <SelectField name="intake" label="Intake" data={INTAKES} required />
            <SelectField
            ...
            <div className="md:col-span-2 xl:col-span-3">
              <Field label="Purpose">
                <textarea name="purpose" className={textareaClassName} />
              </Field>
            </div>
            <div className="md:col-span-2 xl:col-span-3">
              <Field label="Details">
                <textarea name="details" className={textareaClassName} />
              </Field>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            ...
            <div className="md:col-span-2 xl:col-span-3">
              <Field label="Follow Up Remark">
                <textarea name="followUpRemark" className={textareaClassName} />
              </Field>
            </div>
          </CardContent>
        </Card>
